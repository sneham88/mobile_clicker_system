...
@WebServlet("/response3")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class ResponsesServletQ3 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
        ...
        String sqlstr = "INSERT INTO responses (questionNo, choice) VALUES (3, '"
        + choice + "')";
        ...
        out.println("<form action='display3' id= 'questionForm' method='GET'>");
