...
@WebServlet("/display3")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class DisplayServletQ3 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
        ...
        String query = "SELECT choice, COUNT(*) AS count FROM responses WHERE questionNo=3 GROUP BY choice";
        ResultSet rs = stmt.executeQuery(query);

        // Print the results message passing the correct questionNo
        out.println("<h3>Results for Question 3" + ":" + "</h3>");
        ...
        while (rs.next()) {
           ...
           out.println("<a href='question3.html' class='btn btn-secondary mt-2'>Back</a>");
