...
@WebServlet("/response5")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class ResponsesServletQ5 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
        ...
        String sqlstr = "INSERT INTO responses (questionNo, choice) VALUES (5, '"
        + choice + "')";
        ...
        out.println("<form action='display5' id= 'questionForm' method='GET'>");
