...
public class DisplayServletQ4 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
        ...
        String query = "SELECT choice, COUNT(*) AS count FROM responses WHERE questionNo=4 GROUP BY choice";
        ResultSet rs = stmt.executeQuery(query);

        // Print the results message passing the correct questionNo
        out.println("<h3>Results for Question 4" + ":" + "</h3>");
