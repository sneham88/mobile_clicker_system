...
@WebServlet("/display5")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class DisplayServletQ5 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
        ...
        String query = "SELECT choice, COUNT(*) AS count FROM responses WHERE questionNo=5 GROUP BY choice";
        ResultSet rs = stmt.executeQuery(query);

        // Print the results message passing the correct questionNo
        out.println("<h3>Results for Question 5" + ":" + "</h3>");
        ...
        while (rs.next()) {
           ...
           out.println("<a href='question5.html' class='btn btn-secondary mt-2'>Back</a>");
