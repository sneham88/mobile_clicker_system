...
public class WebViewChoiceAActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView.loadUrl("http://192.168.10.75:9999/mobile_clicker_system/response?choice=a");  // Your Tomcat's (localhost:9999) hello app
